...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "bearpanda-ghostblade-princess-fengling",
    name: "BearPanda 鬼刀 風玲公主",
    nameJa: "鬼刀 風鈴公主",
    series: "鬼刀（Ghost Blade）",
    character: "風玲公主（Princess Feng Ling）",
    manufacturer: "BearPanda × 玄機科技（Sparkkey）",
    scale: "1/6",
    price: "¥399 CNY",
    releaseDate: "2027年1月",
    height: "約390mm（含台座）",
    officialUrl: "https://www.hpoi.net/hobby/119365",
    imageUrl: "/images/bearpanda-ghostblade-princess-fengling.jpg",
    tags: ["鬼刀", "Ghost Blade", "風玲公主", "BearPanda", "玄機科技", "Sparkkey", "WLOP", "國漫", "1/6", "中國品牌"],
    description: "BearPanda × 玄機科技（Sparkkey）聯名推出的《鬼刀》（Ghost Blade）原創 IP「風玲公主」1/6 比例完成品。鬼刀系列由知名插畫師 WLOP（不知火君）原創，玄機科技製作動畫版本。風玲公主以高貴氣質著稱，本作以宴會禮服造型立體化，身著金色鏈飾配件與精工頭冠，搭配豐富細節的台座。全高約 390mm，定價 ¥399 CNY，是國漫周邊中極具性價比的收藏級作品。",
    reviews: [
      {
        title: "BearPanda 玄機科技 鬼刀 風玲公主 手辦介紹 | 拆盒網",
        url: "https://www.chaihezi.com/node/375346",
        lang: "zh",
      },
    ],
    youtube: [],
