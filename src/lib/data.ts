...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "alter-xenosaga-iii-kos-mos-telos-color",
    name: "Xenosaga Ⅲ KOS-MOS 水着Ver. テロスカラー（メガホビ限定）",
    nameJa: "Xenosaga Ⅲ KOS-MOS 水着Ver. テロスカラー",
    series: "ゼノサーガ エピソードIII〈ツァラトゥストラはかく語りき〉（Xenosaga Episode III）",
    character: "KOS-MOS（コスモス）/ T-elos 配色",
    manufacturer: "アルター（ALTER）",
    scale: "1/6",
    price: "メガホビ限定",
    releaseDate: "2009年2月（メガホビEXPO 2009 Winter 限定）",
    height: "約 300mm",
    officialUrl: "https://www.alter-web.jp/products/170/",
    imageUrl: "/images/alter-xenosaga-iii-kos-mos-telos-color-swimsuit.jpg",
    tags: ["Xenosaga", "ゼノサーガ", "KOS-MOS", "T-elos", "テロス", "ALTER", "アルター", "1/6", "水着", "Swimsuit", "メガホビ限定", "日系品牌", "ナムコ"],
    description: "アルター（ALTER）的《ゼノサーガ エピソードIII》KOS-MOS 水着Ver. 的 T-elos 配色版本，為 2009 年 メガホビEXPO 冬季活動及 メガトレショップ 限定商品。以對立角色 T-elos 的深色調重新塗裝——小麥肌、黑紫金水着、深紅配件，與通常版白色形成鮮明對比。原型師矢遠 双嗣，全高約 300mm，附兩把小刀、腳環、底座。",
    reviews: [],
    youtube: [
      { title: "Xenosaga 3 Kos-Mos Swimsuit 1/6 Scale Figure Unboxing", url: "https://www.youtube.com/watch?v=XSZvKpqETlY", lang: "en" },
    ],
  },
  {
