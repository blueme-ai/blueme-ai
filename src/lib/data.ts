...
export const collection: CollectibleItem[] = [
  ...
  },
  {
    ...
    description: "潤羽るしあ（Uruha Rushia）是VTuber事務所hololive production 2期生成員，設定為溫柔知性的魔女少女，招牌是她獨特而富有感染力的甜美嗓音與充滿魅力的歌唱實力，出道以來累積大量死忠粉絲，是hololive 2期生成員中歌唱能力備受肯定的一位。本商品重現她招牌的魔女帽與深綠色系長髮造型，白色蕾絲滾邊的黑色魔女服裝搭配蝴蝶結與披肩細節，將原作插畫中優雅神秘的魔女形象轉化為Q版比例後依然保有鮮明辨識度。造型手持法杖，姿態端莊中帶著俏皮，表情零件設計兼顧溫柔恬靜與活潑可愛兩種面向，讓收藏者能重現她直播中不同情境下的多變魅力。作為hololive 2期生成員周邊收藏中人氣與詢問度都相當高的一款，本商品服裝細節與髮絲光澤處理皆屬同期Nendoroid中上乘水準，對魔女系角色與VTuber周邊收藏者而言都深具意義。",
    reviews: [],
    youtube: [
      {
