...
export const collection: CollectibleItem[] = [
  ...
  },
  {
    ...
    description: "《鳥人戦隊ジェットマン》（1991）是超級戰隊系列第15作，也是該系列首度嘗試以濃厚戀愛喜劇元素貫穿主線敘事的作品，五位主角因意外獲得鳥類特徵超能力而組成戰隊，劇中錯綜複雜的多角戀情節在當年掀起話題，長年被粉絲譽為戰隊系列敘事層面的高峰之作。テトラボーイ是劇中登場的3號機器人，也是超級戰隊系列史上首度推出的「3號機」機體，其獨立於主力合體機器人之外、單獨行動支援作戰的設定，在當時的戰隊機體體系中別具開創性意義。本商品是「SMP（食玩模型計畫）」系列推出的食玩塑膠組裝模型，屬於Premium Bandai限定通路商品，忠實重現テトラボーイ黃金與紅色為主調的鳥類造型裝甲，翅膀與頭部裝飾等細節皆透過分件與貼紙呈現，兼顧食玩商品線的親民定位與模型愛好者對於細節與組裝樂趣的要求。作為SMP系列少見聚焦特攝戰隊機體題材的商品之一，對《ジェットマン》系列粉絲與特攝機體收藏者而言，是重現「首代3號機」歷史地位不可或缺的一件周邊。",
    reviews: [],
    youtube: [],
  },
  {
