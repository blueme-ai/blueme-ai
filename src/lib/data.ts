...
export const collection: CollectibleItem[] = [
  ...
  },
  {
    ...
    price: "NT$7,900",
    releaseDate: "2024年",
    officialUrl: "https://p-bandai.com/tw/item/A2769389003",
    imageUrl: "/images/gff-mc-wing-gundam-zero-cloaked.jpg",
    tags: ["Gundam Wing", "飛翼零式", "GFF", "METAL COMPOSITE", "Bandai", "合金"],
    description: "《新機動戰記鋼彈W Endless Waltz》（1997）主角機 XXXG-00W0 Wing Gundam Zero（飛翼零式）的 GUNDAM FIX FIGURATION METAL COMPOSITE（GFF MC）完成品，特別加入「Cloaked Custom（換裝外裝版）」追加零件套組。\n\nGFF METAL COMPOSITE 系列是 Bandai Namco 旗下頂級完成品品牌，主體以 ABS、PVC 及壓鑄合金（ダイキャスト）混合構成，呈現有別於一般塑膠模型的金屬分量感與光澤。Cloaked Custom 版本在標準版 Wing Zero EW 的基礎上，附有替換用的外裝甲板零件，可為機體套上深色外裝「披風」，重現《Endless Waltz》劇中 Wing Zero 的特殊作戰配置。\n\n翅翼由多層活動關節羽毛拼組而成，展開狀態下氣勢極為壯觀；各關節具備良好可動性，可擺出多種姿勢。整體完成度是 GFF MC 系列中的高水準之作，兼顧收藏性與可動性。",
    reviews: [],
    youtube: [
      {
        title: "万代GFFMC 飞翼高达[EW] 开箱试玩 — 戴萌兔",
        url: "https://www.youtube.com/watch?v=zGbT1FOoYpI",
        lang: "zh",
      },
      {
        title: "思わず絶叫する！ウイングガンダムゼロ クロークドカスタム GFF MC レビュー",
  ...
  },
  {
    ...
    character: "GAT-X131 プロヴィデンスガンダム / Providence Gundam",
