...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "megahouse-lucrea-mai-shiranui-kof98",
    name: "Lucrea THE KING OF FIGHTERS '98 Mai Shiranui",
    nameJa: "LUCREA ザ・キング・オブ・ファイターズ'98 不知火舞",
    series: "THE KING OF FIGHTERS '98",
    character: "不知火舞（Mai Shiranui）",
    manufacturer: "MegaHouse",
    scale: "1/7",
    price: "¥25,300",
    releaseDate: "2026年10月",
    height: "約250mm（含傘280mm）",
    officialUrl: "https://www.amiami.com/eng/detail/?gcode=FIGURE-179364",
    imageUrl: "/images/megahouse-lucrea-mai-shiranui-kof98.jpg",
    tags: ["KOF", "King of Fighters", "Mai Shiranui", "不知火舞", "1/7", "MegaHouse", "Lucrea", "SNK", "正版授權", "美少女"],
    description: "MegaHouse 旗下 Lucrea 系列與 SNK 正版授權合作，以 Hiroaki 老師全新繪製插圖為藍本立體化的《拳皇 '98》不知火舞。獨特的夕陽色調塗裝賦予服裝懷舊而富電影感的深度，附招牌「日本一」傘，完整再現不知火舞勝利姿態。全高約250mm（含傘280mm），1/7比例固定姿勢人形，預計2026年10月出貨。",
    reviews: [],
    youtube: [],
  },
]
