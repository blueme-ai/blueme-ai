...
export const collection: CollectibleItem[] = [
  ...
  },
  {
    ...
    officialUrl: "https://tamashii-nation.tamashiiweb.com/2009/limited/index.html",
    imageUrl: "/images/appendix-gemini-saga-original-color-edition.jpg",
    tags: ["SAINT0001", "聖闘士星矢", "聖闘士聖衣神話APPENDIX"],
    description: "《聖闘士星矢》描繪身披聖衣的聖鬥士們為守護女神雅典娜而戰的熱血故事。双子座サガ因體內邪惡人格覺醒而弒殺教皇篡位，是黃金聖鬥士中悲劇色彩最深刻的角色。「聖闘士聖衣神話APPENDIX」是以彩色半身胸像形式呈現角色的補完商品線，可更換頭部零件重現サガ與弟弟カノン兩種角色。本品為2009年「TAMASHII NATION 2009」會場限定販售的「ORIGINAL COLOR EDITION」版本，忠實還原車田正美原作漫畫中的配色設定，與後續一般販售的動畫版塗裝形成對比，且商品內容不含另售的專用展示台座，僅限會場現場販售，是喜愛比較不同媒體配色版本、蒐集活動限定商品玩家的珍藏對象。",
    reviews: [],
    youtube: [],
  },
  {
