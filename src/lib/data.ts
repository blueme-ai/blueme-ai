...
export const collection: CollectibleItem[] = [
  {
    ...
    reviews: [
      {
        title: "KADOKAWA Fate HF Saber Alter 和服Ver. 開箱 — 粉色蒂國",
        url: "https://www.youtube.com/watch?v=SeGDPzwbTxA",
        lang: "zh",
      },
      {
        title: "セイバーオルタ 着物ver. 公式PV — KDcolle",
        url: "https://www.youtube.com/watch?v=rkHmZPs6hoo",
        lang: "ja",
      },
    ],
    youtube: [
  ...
  },
  {
    ...
    reviews: [
      {
        title: "壽屋 FGO 1/7 貞德alter 私服ver. 開箱 — 六樓只弟團",
        url: "https://www.youtube.com/watch?v=8LeQr5P69W0",
        lang: "zh",
      },
      {
        title: "ジャンヌ・ダルク〔オルタ〕 カジュアルver. 製品紹介 — コトブキヤ公式",
  ...
  },
  {
    ...
    reviews: [
      {
        title: "MG Turn A Gundam Moonlight Butterfly Ver. 簡單開箱 — 金金貓模型",
        url: "https://www.youtube.com/watch?v=pZRq3XpElt8",
        lang: "zh",
      },
      {
        title: "月光蝶エフェクトユニットが美しい MG ∀ガンダム — サボリーマンのガンプラ製作部",
        url: "https://www.youtube.com/watch?v=0SiS_7WVkU4",
        lang: "ja",
      },
    ],
    youtube: [
  ...
  },
  {
    ...
    reviews: [
      {
        title: "やまと 完全変形 1/60 YF-21 ガルド機 レビュー — Mark H.",
        url: "https://www.youtube.com/watch?v=_yC25p5hMus",
        lang: "ja",
      },
      {
        title: "YF-21 Showdown: Yamato 1/60 vs Bandai DX — ScorchedEarthToys",
        url: "https://www.youtube.com/watch?v=x7zw_NrD4Nk",
        lang: "en",
      },
    ],
    youtube: [
  ...
  },
  {
    ...
    reviews: [
      {
        title: "開箱 MG 1/100 RX-78-2 鋼彈3.0 TGB配色 — tony ver",
        url: "https://www.youtube.com/watch?v=nG3sM_0hvR8",
        lang: "zh",
      },
      {
        title: "ガンダムベース限定 MG G-3ガンダム 素組レビュー — 雪プラ堂",
