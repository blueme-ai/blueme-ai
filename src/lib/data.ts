...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "gsc-nikke-modernia-17",
    name: "勝利の女神：NIKKE Modernia 1/7スケールフィギュア",
    nameJa: "勝利の女神：NIKKE Modernia 1/7スケールフィギュア",
    series: "勝利女神：妮姬（Goddess of Victory: NIKKE）",
    character: "Modernia",
    ...
    releaseDate: "2026年3月",
    height: "約230mm",
    officialUrl: "https://www.goodsmile.com/zh/product/36120/",
    imageUrl: "/images/gsc-nikke-modernia-17.jpg",
    tags: ["NIKKE", "勝利女神", "Modernia", "Good Smile", "GSC", "1/7", "日系品牌", "ガトリング"],
    description: "Good Smile Arts Shanghai 推出的《勝利女神：妮姬（NIKKE）》「Modernia」1/7 比例完成品。精細再現 Modernia 的貼身戰鬥服裝與背部大型機砲裝備，武器可拆卸並附替換零件供多種展示。細膩的多層塗裝重現服裝材質層次感，灰銀色長髮與紅色眼眸栩栩如生，全高約 230mm。",
    reviews: [],
    youtube: [],
  },
]
