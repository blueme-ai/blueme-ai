...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "alter-xenosaga-iii-kos-mos-swimsuit",
    name: "Xenosaga Ⅲ KOS-MOS 水着Ver.",
    nameJa: "Xenosaga Ⅲ KOS-MOS 水着Ver.",
    series: "ゼノサーガ エピソードIII〈ツァラトゥストラはかく語りき〉（Xenosaga Episode III）",
    character: "KOS-MOS（コスモス）",
    manufacturer: "アルター（ALTER）",
    scale: "1/6",
    price: "¥8,800（稅込）",
    releaseDate: "2009年1月（初版）/ 2013年8月（再販）",
    height: "約 300mm",
    officialUrl: "https://www.alter-web.jp/products/170/",
    imageUrl: "/images/alter-xenosaga-iii-kos-mos-swimsuit.jpg",
    tags: ["Xenosaga", "ゼノサーガ", "KOS-MOS", "ALTER", "アルター", "1/6", "水着", "Swimsuit", "日系品牌", "ナムコ"],
    description: "アルター（ALTER）出品的《ゼノサーガ エピソードIII》女主角「KOS-MOS」水着版 1/6 完成品，原型師矢遠 双嗣精心塑造，於 2009 年 1 月首次發售（2013 年 8 月再販）。全高約 300mm，以機械與有機感並存的造型重現 KOS-MOS 纖細均衡的體態，附刀具配件。水着圖案取材自遊戲內場景設計，細節豐富，白銀長髮與紅瞳為標誌性特徵。",
    reviews: [],
    youtube: [
