...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "hg-astray-red-dragon",
    name: "HG 1/144 ガンダムベース限定 ガンダムアストレイ レッドドラゴン",
    nameJa: "HG 1/144 ガンダムベース限定 ガンダムアストレイ レッドドラゴン",
    series: "機動戦士ガンダムSEED DESTINY ASTRAY R",
    character: "ガンダムアストレイ レッドドラゴン（MBF-P02／ロウ・ギュール機）",
    manufacturer: "Bandai Spirits",
    scale: "HG 1/144",
    price: "¥4,070（含稅）",
    releaseDate: "2022年10月8日（THE GUNDAM BASE限定）",
    officialUrl: "https://www.gundam-base.net/products/details.php?path=01_4352",
    imageUrl: "/images/hg-astray-red-dragon.jpg",
    tags: ["BOX0002", "ガンプラ", "HG", "1/144", "Bandai", "ガンダムSEED ASTRAY", "アストレイ", "THE GUNDAM BASE限定"],
    description: "junk屋組合ロウ・ギュール駕駛的紅色機體最強形態「ガンダムアストレイ レッドドラゴン」，THE GUNDAM BASE限定HG化。頭部換裝為ドラグヘッド，背部搭載三具卡雷特弗爾夫（カレトヴルッフ），可重組為Sモード、Gモード或雙手大戟形態演出多種姿勢；標配格伯拉直式劍、光束步槍及可拆卸光束效果的Bauk偵察頭部等配件，是SEED ASTRAY系列人氣機體的紀念性商品化。",
    reviews: [
      {
        title: "HG ガンダムアストレイ レッドドラゴン レビュー | ガンダムブログはじめました",
        url: "https://gundamsblog.net/%E3%82%AC%E3%83%B3%E3%83%97%E3%83%A9/hg-%E3%82%AC%E3%83%B3%E3%83%80%E3%83%A0%E3%82%A2%E3%82%B9%E3%83%88%E3%83%AC%E3%82%A4-%E3%83%AC%E3%83%83%E3%83%89%E3%83%89%E3%83%A9%E3%82%B4%E3%83%B3",
        lang: "ja",
      },
    ],
    youtube: [],
