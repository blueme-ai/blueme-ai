...
export const collection: CollectibleItem[] = [
  ...
  },
  {
    ...
    name: "DX超合金 VF-25G スーパーメサイアバルキリー（ミハエル・ブラン機）リバイバルVer.",
    nameJa: "DX超合金 VF-25G スーパーメサイアバルキリー（ミハエル・ブラン機）リバイバルVer.",
    series: "マクロスF（Macross Frontier）",
    character: "ミハエル・ブラン（Michael Blanc）",
    manufacturer: "Bandai Spirits／魂ウェブ限定",
    scale: "1/60",
    price: "¥28,600（含稅）",
    releaseDate: "2023年9月23日",
    height: "約300mm（Battroid形態）",
    officialUrl: "https://tamashiiweb.com/item/14354/",
    imageUrl: "/images/dx-chogokin-vf25g-messiah-michael.jpg",
    tags: ["マクロスF", "Macross Frontier", "VF-25G", "メサイアバルキリー", "ミハエル・ブラン", "DX超合金", "1/60", "可變形"],
    description: "《マクロスF》（2008）是河森正治原案的《超時空要塞》系列電視動畫，描繪人類移民艦隊「マクロス・フロンティア」號在銀河邊境遭遇未知生命體「バジュラ」襲擊，飛行員以可變形戰機「バルキリー」與歌聲共同對抗危機的故事。VF-25G是隊員ミハエル・ブラン（Michael Blanc）的專用機，藍白配色搭配專屬狙擊槍，是三架VF-25主力機中偏向支援與精準射擊定位的一架。\n\n此為DX超合金VF-25G「スーパーメサイアバルキリー」ミハエル機的リバイバルVer.（復刻版），1/60比例、Battroid形態全高約300mm，可完整切換Fighter（戰機）、Gerwalk（半人形）、Battroid（人形）三段變形，並可加裝「スーパーパーツ」強化背包套件。復刻版本對機身及超級零件表面施以消光處理、追加部分新增標識塗裝，並附三對替換手型、狙擊槍、可動式錨爪、突擊小刀，以及ミハエル・ブラン與クラン・クラン（小尺寸）駕駛人偶與專用展示台，是マクロスF系列高人氣支線機體的代表商品。",
    reviews: [
      {
        title: "DX超合金 VF-25G メサイアバルキリー(ミハエル・ブラン機) リニューアルVer. レビュー",
        url: "https://hacchaka.net/archives/51845881.html",
        lang: "ja",
      },
      {
  ...
  },
  {
    ...
    youtube: [
      ...
      {
        title: "【ガンプラ】MG ガンダムF91 Ver.2.0 制作&レビュー 水野明佳出演",
        url: "https://www.youtube.com/watch?v=kuIa-LCDrSg",
        lang: "ja",
      },
    ],
  },
