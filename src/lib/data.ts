...
export const collection: CollectibleItem[] = [
  ...
  {
    id: "arcadia-vf19-custom-sound-booster-40th",
    name: "1/60 完全変形 VF-19改 ネッキ・バサラ専用機 w/サウンドブースター（マクロス40周年記念版）",
    nameJa: "1/60 完全変形 VF-19改 ネッキ・バサラ専用機 w/サウンドブースター（マクロス40周年記念版）",
    series: "マクロス7（1994）",
    character: "VF-19改 ファイアバルキリー（ネッキ・バサラ専用）",
    manufacturer: "Arcadia",
    scale: "1/60",
    price: "¥36,000",
    releaseDate: "2022年",
    ...
    imageUrl: "/images/arcadia-vf19-custom-sound-booster-40th.jpg",
    tags: ["マクロス", "Macross", "Arcadia", "バルキリー", "VF-19", "サウンドブースター", "ネッキ・バサラ", "1/60", "合金", "変形", "40周年"],
    description: "Arcadia 1/60 完全変形シリーズ、マクロス40周年記念版として再販されたマクロス7主人公 Fire Bomber のリードボーカル・ネッキ・バサラ専用機 VF-19改 ファイアバルキリー。サウンドブースターを装備した形態を再現し、ファイター・ガウォーク・バトロイドへの3段完全変形に対応。通常版の黃色から金色に変更されたアクセントカラーと高品質の塗装が特徴で、バサラが「歌で戦う」スタイルを象徴する音楽発生装置を完全付属。",
    reviews: [
      {
        title: "Arcadia 1/60 VF-19 Fire Valkyrie from Macross 7 Review",
        url: "https://myfigurecollection.net/blogpost/61564",
        lang: "en",
      },
    ],
    youtube: [
      {
        title: "Nekki Basara's VF-19 Custom Special with Sound Booster [Arcadia] Unboxing | Macross 7",
  ...
  {
    id: "arcadia-vf1j-30th-anniversary",
    name: "1/60 完全変形 VF-1J バルキリー（マクロス30周年記念カラー）",
    nameJa: "1/60 完全変形 VF-1J バルキリー（マクロス30周年記念カラー）",
    series: "超時空要塞マクロス（1982）",
    character: "VF-1J バルキリー（マクロス30周年記念カラー）",
    manufacturer: "Arcadia",
    scale: "1/60",
    price: "¥16,590",
    releaseDate: "2013年8月",
    officialUrl: "https://arcadiashop.jp/",
    imageUrl: "/images/arcadia-vf1j-30th-anniversary.jpg",
    tags: ["マクロス", "Macross", "Arcadia", "バルキリー", "VF-1J", "1/60", "合金", "変形", "30周年", "天神英貴"],
    description: "Arcadiaブランドとして初めてリリースされた記念碑的な一品、超時空要塞マクロス30周年を記念した1/60 完全変形 VF-1J バルキリー。著名メカニカルデザイナー・天神英貴が監修した特別カラーリングを採用し、豪華なフリップトップ蓋付きホワイトボックスに金箔印刷が施された premium なパッケージに収録。附ウォータースライドデカール・プレスオンシール・ディスプレイスタンド付き。",
    reviews: [],
    youtube: [
      {
  ...
  {
    id: "arcadia-vf4a-lightning-iii",
    name: "1/60 完全変形 VF-4A ライトニングIII（一条輝機）",
    nameJa: "1/60 完全変形 VF-4A ライトニングIII（一条輝機）",
    series: "超時空要塞マクロス フラッシュバック2012（1987）",
    character: "VF-4A ライトニングIII（一条輝専用機）",
    manufacturer: "Arcadia",
    scale: "1/60",
    price: "¥29,800",
    releaseDate: "2021年7月（第2次生産）",
    officialUrl: "https://arcadiashop.jp/",
    imageUrl: "/images/arcadia-vf4a-lightning-iii.jpg",
    tags: ["マクロス", "Macross", "Arcadia", "バルキリー", "VF-4A", "ライトニングIII", "一条輝", "1/60", "合金", "変形", "フラッシュバック2012"],
    description: "Arcadia 1/60 完全変形シリーズ、《超時空要塞マクロス フラッシュバック2012》（1987）より一条輝が搭乗した VF-4A ライトニングIII の2021年第2次生産版。VF-1 の後継機として開発された次世代可変戦闘機で、より洗練されたシルエットと優れた機動性を持つ。ファイター・ガウォーク・バトロイドへの完全変形に対応し、コクピット内には搭乗可能な一条輝ミニフィギュアも同梱。全長約30cmの大型スケールで圧倒的な存在感を誇る。",
    reviews: [],
    youtube: [
      {
        title: "Arcadia 1/60 scale VF-4A Lightning III Review",
  ...
  },
  {
    ...
    price: "$99.90 USD",
    releaseDate: "2025年",
    officialUrl: "https://www.threezerohk.com/product/dlx-iron-man-mark-21-midas/",
    imageUrl: "/images/dlx-iron-man-mark21-midas.jpg",
    tags: ["Marvel", "Iron Man", "鋼鐵人", "threezero", "DLX", "Infinity Saga", "1/12", "可動", "合金", "Midas", "黃金"],
    description: "threezero DLX 系列 Tony Stark 以神話中「點石成金之王 Midas」為命名的全金色豪華裝甲 Mark XXI，為《鋼鐵人3》Iron Legion 系列裝甲之一。多層次金屬電鍍塗裝打造出奢華的純金外觀，搭載 DLX 壓鑄合金骨架與48個可動關節，眼部與胸部反應堆均有 LED 發光效果。附可展開的背部氣流導流板與完整武器配件組（手刃、雷射手腕、導彈附件等）。",
    reviews: [],
    youtube: [],
  },
  {
    id: "dlx-iron-man-mark50-accessory-pack",
    name: "threezero DLX 鋼鐵人 Mark L 武器配件組",
    nameJa: "threezero DLX アイアンマン マーク50 アクセサリーパック",
    series: "Marvel Cinematic Universe / Avengers: Infinity War (2018)",
    character: "Iron Man（Mark L / Mark 50）武器擴充配件",
    manufacturer: "threezero",
    scale: "1/12",
    price: "$85 USD",
    releaseDate: "2022年",
    ...
    imageUrl: "/images/dlx-iron-man-mark50-accessory-pack.jpg",
    tags: ["Marvel", "Iron Man", "鋼鐵人", "threezero", "DLX", "Infinity Saga", "1/12", "配件", "奈米科技", "武器"],
    description: "threezero DLX 系列 Mark L（Mark 50）專用武器擴充配件組，為《復仇者聯盟：無限之戰》中 Tony Stark 以奈米科技召喚的各式武器提供精緻重現。配件包含手刃、排斥砲（附 LED）、動力槌（附 LED）、盾牌、圓形盾、奈米推進器、衝擊錘×2（附 LED）、零能炮×2（附 LED）、能量驅散哨兵×4（附 LED），讓 DLX Mark 50 達到《無限之戰》全武裝最強展示形態。",
    reviews: [],
    youtube: [],
  },
  {
    id: "hg-gself-perfect-pack",
    name: "HG 1/144 ガンダム G-Self パーフェクトパック装備型（劇場版 Ver.）",
    nameJa: "HG 1/144 ガンダム G-Self パーフェクトパック装備型（劇場版 Ver.）",
    series: "Gのレコンギスタ（2014）",
    character: "YG-111 ガンダム G-Self",
    manufacturer: "Bandai Spirits",
    scale: "HG 1/144",
    price: "¥3,850（ガンダムベース限定）",
    releaseDate: "2024年10月",
    officialUrl: "https://p-bandai.com/us/item/F2715394003/",
    imageUrl: "/images/hg-gself-perfect-pack.jpg",
    tags: ["ガンプラ", "HG", "Bandai", "Gのレコンギスタ", "G-Self", "パーフェクトパック", "高達模型", "ガンダムベース限定", "G-Reco"],
    description: "Bandai Spirits ガンダムベース限定 HG 1/144《劇場版 Gのレコンギスタ》版本 YG-111 G-Self パーフェクトパック装備型，為 G-Reco 10周年紀念商品（2024年）。劇場版 Ver. 以新規造形頭部・胸部・肩部・シールドを採用し、電影最終決戦形態を精密再現。パーフェクトパックは宇宙・大気層両用推進システムを搭載し、展開形態も再現可能。附 Action Base 7 展示台座。",
    reviews: [],
    youtube: [
      {
        title: "Gundam Base Limited HG Gundam G-Self Perfect Pack Movie Ver. Review",
        url: "https://www.youtube.com/watch?v=venW8iHK91w",
        lang: "en",
      },
    ],
  },
  {
    id: "nendoroid-snow-miku-crystal-snow-2026",
    name: "ねんどろいど 雪ミク Crystal Snow Ver.（#2643）",
    nameJa: "ねんどろいど 雪ミク Crystal Snow Ver.（#2643）",
    series: "初音ミク / Snow Miku 2025",
    character: "初音ミク（Snow Miku Crystal Snow Ver.）",
    manufacturer: "Good Smile Company",
    scale: "non-scale（約100mm）",
    price: "¥8,300",
    releaseDate: "2025年2月",
    officialUrl: "https://www.goodsmile.com/zh-tw/product/60968/",
    imageUrl: "/images/nendoroid-snow-miku-crystal-snow-2026.jpg",
    tags: ["初音ミク", "Hatsune Miku", "Nendoroid", "ねんどろいど", "Good Smile", "雪ミク", "Snow Miku", "Crystal Snow", "Vocaloid"],
    description: "Good Smile Company ねんどろいど #2643 Snow Miku「Crystal Snow Ver.」，以「輝く雪の素材」為主題，由插畫家 nekoneko 設計，為 Snow Miku 16周年（2025年）紀念版本。晶瑩剔透的水晶配件搭配白銀雪花圖紋，附笑臉、愛心眼神、興奮表情三款替換臉，以及雪兔（Rabbit Yukine）、魔法杖、愛心效果配件等多款造型道具，完整呈現「輝く雪の輝き」的夢幻世界觀。",
    reviews: [],
    youtube: [
      {
        title: "Nendoroid Snow Miku 2025 Unbox & Review",
  ...
  },
  {
    ...
    series: "マクロスF（2007）/ GALAXY LIVE☆FINAL 2025記念",
    character: "YF-29（アルト・サオトメ機）＋シェリル・ノーム＆ランカ・リー",
    manufacturer: "Max Factory",
    scale: "1/20",
    price: "¥15,400",
    releaseDate: "2026年4月",
    officialUrl: "https://www.goodsmile.com/zh-tw/product/1142180/",
    imageUrl: "/images/plamax-mf98-yf29-galaxy-set.jpg",
    tags: ["マクロスF", "Macross Frontier", "YF-29", "PLAMAX", "Max Factory", "1/20", "プラモデル", "シェリル", "ランカ", "アルト", "GALAXY SET"],
    description: "Max Factory PLAMAX MF-98 minimum factory 系列，為《マクロスFrontier》GALAXY LIVE☆FINAL 2025 演唱會紀念套裝。1/20 比例 YF-29 全長約340mm，以金黑雙色搭配精緻金屬光澤塗裝呈現，機身設計基於 Risa Ebata 繪製的活動 Key Visual。套裝同時收錄約90mm 高的アルト・サオトマ、シェリル・ノーム、ランカ・リー 三名人物模型（附特殊金屬光澤塗裝），並含 B5 尺寸水貼（2張），是マクロスF 粉絲的夢幻紀念限定套裝。",
    reviews: [],
    youtube: [],
  },
  {
    id: "rg-unicorn-banshee-norn-final-battle",
    name: "RG 1/144 RX-0[N] ユニコーンガンダム 02 バンシィ・ノルン（最終決戦仕様）",
    nameJa: "RG 1/144 RX-0[N] ユニコーンガンダム 02 バンシィ・ノルン（最終決戦仕様）",
    series: "機動戦士ガンダムUC（2010）",
    character: "RX-0[N] ユニコーンガンダム 02 バンシィ・ノルン（リディ・マーセナス搭乗機）",
    manufacturer: "Bandai Spirits",
    scale: "RG 1/144",
    price: "¥7,700（プレミアムバンダイ）",
    releaseDate: "2021年12月",
    officialUrl: "https://p-bandai.com/us/item/N2459527001002",
    imageUrl: "/images/rg-unicorn-banshee-norn-final-battle.jpg",
    tags: ["ガンプラ", "RG", "Bandai", "ガンダムUC", "バンシィ・ノルン", "最終決戦", "高達模型", "プレミアムバンダイ限定"],
    description: "Bandai Spirits プレミアムバンダイ限定 RG 1/144《機動戦士ガンダムUC》バンシィ・ノルン最終決戦仕様。最大の特徴は最終決戦時のサイコフレームをクリアグリーンカラーで成型色再現した点で、通常版の赤と異なる神秘的な輝きを放つ。パーツ交換不要でユニコーンモード⇔デストロイモード変形に対応し、アームド・アーマー DE（盾展開）・XC（背部）も装備した最強形態を完全再現。",
    reviews: [],
    youtube: [
      {
        title: "Real Grade RG Banshee Norn Final Battle Ver. Review",
  ...
  {
    id: "va-30spec-super-granzort",
    name: "Variable Action Hi-SPEC 魔動王グランゾート スーパーグランゾート（30周年記念版）",
    nameJa: "Variable Action Hi-SPEC 魔動王グランゾート スーパーグランゾート（30周年記念版）",
    series: "魔動王グランゾート（1989）",
    character: "スーパーグランゾート",
    manufacturer: "MegaHouse",
    scale: "non-scale（全高220mm）",
    price: "¥36,000",
    releaseDate: "2020年1月",
    officialUrl: "https://www.megahouse.co.jp/",
    imageUrl: "/images/va-30spec-super-granzort.jpg",
    tags: ["魔動王グランゾート", "グランゾート", "MegaHouse", "Variable Action", "Hi-SPEC", "30周年", "超合金", "發光", "聲音"],
    description: "MegaHouse Variable Action Hi-SPEC 系列《魔動王グランゾート》30周年記念版スーパーグランゾート，同時慶祝 Variable Action 系列10周年。全高 220mm と従来の VA シリーズより約30%大型化し、精細なディテールと低下すると発光するガイアバイザーを搭載。声優・大滝進矢氏の新録ボイスと連動したサウンド＆5色ライトアップ魔法陣ベース付きで、フェイスモード⇔バトルモードの切り替えも可能な豪華仕様。",
    reviews: [],
    youtube: [],
  },
  {
    id: "yamato-vf0a-macross-zero",
    name: "ヤマト 1/60 完全変形 VF-0A フェニックス（新庄シン機）",
    nameJa: "ヤマト 1/60 完全変形 VF-0A フェニックス（新庄シン機）",
    series: "マクロスZERO（2002）",
    character: "VF-0A フェニックス（新庄シン搭乗機）",
    manufacturer: "Yamato",
    scale: "1/60",
    price: "¥16,800（2010年再版）",
    releaseDate: "2004年（初版）/ 2010年（再版）",
    officialUrl: "https://www.hlj.com/1-60-scale-vf-0a-ymt00042",
    imageUrl: "/images/yamato-vf0a-macross-zero.jpg",
    tags: ["マクロス", "Macross", "Yamato", "バルキリー", "VF-0A", "マクロスZERO", "1/60", "合金", "変形"],
    description: "Yamato 1/60 完全変形シリーズの《マクロスZERO》より、主人公・新庄シンが搭乗する VF-0A フェニックス（量産型）。VF-1 バルキリーの先行開発機として登場する VF-0 は、従来型ジェットエンジンを使用した大型可変戦闘機で、VF-1 よりも大きく重厚なリアル系シルエットが特徴。1/60 スケールながらファイターモード時全長310mm を誇る迫力ある大型トイで、ファイター・ガウォーク・バトロイドへの完全変形機構を実現。",
    reviews: [],
    youtube: [],
  },
]
